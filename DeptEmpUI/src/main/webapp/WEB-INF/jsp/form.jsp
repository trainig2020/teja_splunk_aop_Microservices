			...
			<c:forEach var="dept" items="${deptLst}">
				<c:if test="${not empty dept}">
					...
					&nbsp;&nbsp;<button type="button" class="btn btn-success"
						style="width: 100px;">
						<a href="listEmp?deptId=${dept.deptId}"><font color="black">${dept.deptName}
						</font></a>
					</button>
					<br>
					...
					<tbody>
								...
								<c:if test="${deptId eq emp.deptId}">
									<tr>
										...
										<td><select name="deptName">
												...
												<c:forEach items="${deptLst}" var="depnt">
													<c:if test="${dept.deptName ne depnt.deptName}">
						...
						<c:if test="${addEmp eq 'regEmp'}">
							<tr>
								...
								<td ><select name="deptName" required>
